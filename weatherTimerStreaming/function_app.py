...
def weatherapifunction(myTimer: func.TimerRequest) -> None:
    ...
    EVENT_HUB_NAME = "weatherstreamingspace1"

    EVENT_HUB_NAMESPACE = "weatherstreamingspace1.servicebus.windows.net" 
    ...
    def fetch_weather_data():
        ...
        location = "Tokyo"  # You can replace with any city name based on your preference
